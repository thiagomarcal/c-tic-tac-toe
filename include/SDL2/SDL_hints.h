 ...
 *
 *  The variable can be set to the following values:
 *    "0"       - Report the face buttons by board_position, as though they were on an Xbox controller.
 *    "1"       - Report the face buttons by label instead of board_position
 *
 ...
 *  board_position when using high DPI mice.
 *
 ...
 *  transitions. In order to correctly board_position overlays (e.g. volume bar) and
