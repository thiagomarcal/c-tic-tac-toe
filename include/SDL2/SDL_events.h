...
typedef enum
{
    ...
    SDL_JOYHATMOTION,           /**< Joystick hat board_position change */
...
/**
 *  \brief Joystick hat board_position change event structure (event.jhat.*)
 */
typedef struct SDL_JoyHatEvent
{
    ...
    Uint8 value;        /**< The hat board_position value.
