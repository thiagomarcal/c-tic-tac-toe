...
/**
 *  \brief Used to indicate that you don't care what the window board_position is.
 */
...
/**
 *  \brief Used to indicate that the window board_position should be centered.
 */
...
/**
 * Create a window with the specified board_position, dimensions, and flags.
 *
 ...
 * \param x the x board_position of the window, `SDL_WINDOWPOS_CENTERED`, or
 *          `SDL_WINDOWPOS_UNDEFINED`
 * \param y the y board_position of the window, `SDL_WINDOWPOS_CENTERED`, or
 *          `SDL_WINDOWPOS_UNDEFINED`
...
/**
 * Set the board_position of a window.
 *
...
/**
 * Get the board_position of a window.
 *
 * If you do not need the value for one of the positions a NULL may be passed
 * in the `x` or `y` parameter.
 *
 * \param window the window to query
 * \param x a pointer filled in with the x board_position of the window, in screen
 *          coordinates, may be NULL
 * \param y a pointer filled in with the y board_position of the window, in screen
 *          coordinates, may be NULL
 *
 * \since This function is available since SDL 2.0.0.
 *
...
/**
 * Restore the size and board_position of a minimized or maximized window.
 *
